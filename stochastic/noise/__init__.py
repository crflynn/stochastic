...
from stochastic.noise.colored_noise import PinkNoise
from stochastic.noise.colored_noise import RedNoise
from stochastic.noise.colored_noise import VioletNoise
